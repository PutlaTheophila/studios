// GET /api/sourcing/:id — fetch one record
// PATCH /api/sourcing/:id — update
...
const SOURCING_DATE_FIELDS = ['source_date', 'return_date'] as const;
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  blankDatesToNull(rest, SOURCING_DATE_FIELDS);
  const supabase = createSupabaseServerClient();
